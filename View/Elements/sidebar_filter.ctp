...
<div class="panel sidebar_section" id="filters_sidebar_section">
    ...
    <div class="panel_contents">
        ...
        <div class="filter_form_field <?php echo "filter_" . $filter_field_type=$model->getColumnType($displayField); ?>">
            <label> <?php echo __('Search %s', Inflector::humanize($displayField)) ?></label>
            <?php echo $this->Form->input($modelName . '.' . $displayField, array('type'=>$filter_field_type,'label' => false, 'required' => false, 'div' => false)); ?>
        </div>
